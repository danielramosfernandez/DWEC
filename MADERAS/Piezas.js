...
if (!Array.isArray(piezas)) {
    piezas = [];
    guardarPiezas(); // Aseguramos guardar un array vacío
}
...
document.getElementById("formularioAñadir").addEventListener("submit", (e) => {
    ...
    const numPedi = parseInt(document.getElementById("numPedi").value, 10);
    ...
    añadirPieza(numPieza, numPedi, largo, ancho, grosor, color, ambasCaras, cortada);
...
function formularioModificacion(numPieza) {
    ...
    // Mostrar los botones de modificación y eliminación
